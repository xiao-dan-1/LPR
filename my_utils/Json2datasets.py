...
def dataset_to_trainset(in_path, train_images_path, train_labels_path):
    ...
    for file_path in files_path:
        ...
        if 'img.png' == file_name:
            ...
            save_path = os.path.join(train_images_path, f'{os.path.split(root)[-1]}.png')
            ...
            save_path = os.path.join(train_labels_path, f'{os.path.split(root)[-1]}.png')
            cv2.imwrite(save_path, label)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--in_path', type=str, default='json', help='json path')
    parser.add_argument('--out_path', type=str, default='data', help='out data path')
    parser.add_argument('--train_images_path', type=str, default='train_images', help='out train images path')
    parser.add_argument('--train_labels_path', type=str, default='train_labels', help='out train_labels path')
