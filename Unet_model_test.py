...
def train_model(model, X_train, X_test, y_train, y_test, batch_size, num_epochs,
    ...
    # 计算样本权重
    class_weights = {0: 0.5, 1: 10000}  # 类别权重，根据实际情况设置
...
if __name__ == '__main__':
    ...
    # show_augmented_result_demo
    show_augmented_result_demo(X_train, X_train_augmented, y_train_augmented)
